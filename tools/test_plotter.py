...
fname = '/Users/justinellin/repos/python_SIS3316/Data/2020-01-21-1126Adam.bin'
...
print("Number of  Raw Samples: ", 2 * (arr[10] + ((arr[11] & 0x3FF) << 16)))
...
x = np.arange(2 * (arr[10] + ((arr[11] & 0x3FF) << 16))) # 70 for PGI
plt.step(x * 4, arr[12:])
plt.xlabel('Time (ns)')
